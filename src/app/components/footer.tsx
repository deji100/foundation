      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 md:gap-4">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex gap-4 justify-center">
            <a
              href="https://facebook.com/georgetaylorfoundation"
              target="_blank"
            ...
            <a
              href="https://twitter.com/georgetaylorfoundation"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              href="https://instagram.com/georgetaylorfoundation"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              href="https://linkedin.com/company/georgetaylorfoundation"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              href="https://youtube.com/@georgetaylorfoundation"
              target="_blank"
              rel="noopener noreferrer"
            >
